...
> **Fork Notice:** This is a personal fork of [NotPunchnox/rkllama](https://github.com/NotPunchnox/rkllama) for use on my Turing Pi RK1 cluster.
...
* Version `Lib rkllm-runtime`: V1.2.3.
